 ...
 */
@WebServlet(name = "ModifyGateServlet")
public class ModifyGateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println(Methods.getCurrentTime()+": ModifyGateServlet运行完毕!");
        ...
        synchronized (application){
            ...
            for(int i = 0;i < n;i++){
                ...
                if(w.getWatergateid().equals(id)){
                    ...
                    DataBase.updateWaterGate(wg);
                    response.sendRedirect("main.jsp");
                    return;
                }
            }
        }
        response.sendRedirect("modifyGate.jsp");
    }
}
